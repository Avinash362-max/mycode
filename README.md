...
Now retrieve some meaningful, important data from whole dataset.
...
POLLYTANT TYPE AND TOTAL CASES
 
FARMING PRACTICE AND TOTAL CASES
 
NEARBY INDUSTRIES AND TOTAL CASES
 
DISEASE TYPE AND TOTAL CASES
 
DISEASES SEVIRITY AND TOTAL CASES
 
HEALTH SYMPTOMS AND TOTAL CASES
 
MALE FEMALE RATIO AND TOTAL CASES
 
MITIGATION MEASURE AND TOTAL CASES
 

CASE RESOLVED AND PENDING
